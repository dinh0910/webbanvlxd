...
namespace webbanvlxd.Areas.Admin.Controllers
{
    ...
    public class QuyenHansController : Controller
    {
        ...
        public QuyenHansController(webbanvlxdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.QuyenHan != null ? 
                          ...
                          Problem("Entity set 'webbanvlxdContext.QuyenHan'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbanvlxdContext.QuyenHan'  is null.");
            }
            var quyenHan = await _context.QuyenHan.FindAsync(id);
            if (quyenHan != null)
            {
