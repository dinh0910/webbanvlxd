...
namespace webbanvlxd.Areas.Admin.Controllers
{
    ...
    public class DanhMucsController : Controller
    {
        ...
        public DanhMucsController(webbanvlxdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.DanhMuc != null ? 
                          ...
                          Problem("Entity set 'webbanvlxdContext.DanhMuc'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("DanhMucID,LoaiDanhMucID,Ten")] DanhMuc danhMuc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DanhMucID,LoaiDanhMucID,Ten")] DanhMuc danhMuc)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbanvlxdContext.DanhMuc'  is null.");
            }
            var danhMuc = await _context.DanhMuc.FindAsync(id);
            if (danhMuc != null)
            {
