...
namespace webbanvlxd.Areas.Admin.Controllers
{
    ...
    public class TaiKhoansController : Controller
    {
        ...
        public TaiKhoansController(webbanvlxdContext context)
        {
            _context = context;
        }
        ...
        {
            var webbanvlxdContext = _context.TaiKhoan.Include(t => t.QuyenHan);
        ...
        public async Task<IActionResult> Create([Bind("TaiKhoanID,TenTaiKhoan,MatKhau,HoTen,SoDienThoai,Email,DiaChi,QuyenHanID")] TaiKhoan taiKhoan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaiKhoanID,TenTaiKhoan,MatKhau,HoTen,SoDienThoai,Email,DiaChi,QuyenHanID")] TaiKhoan taiKhoan)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbanvlxdContext.TaiKhoan'  is null.");
            }
            var taiKhoan = await _context.TaiKhoan.FindAsync(id);
            if (taiKhoan != null)
            {
