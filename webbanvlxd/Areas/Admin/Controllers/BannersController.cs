...
namespace webbanvlxd.Areas.Admin.Controllers
{
    ...
    public class BannersController : Controller
    {
        ...
        public BannersController(webbanvlxdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Banner != null ? 
                          ...
                          Problem("Entity set 'webbanvlxdContext.Banner'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbanvlxdContext.Banner'  is null.");
            }
            var banner = await _context.Banner.FindAsync(id);
            if (banner != null)
            {
