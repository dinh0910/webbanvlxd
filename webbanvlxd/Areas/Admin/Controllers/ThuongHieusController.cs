...
namespace webbanvlxd.Areas.Admin.Controllers
{
    ...
    public class ThuongHieusController : Controller
    {
        ...
        public ThuongHieusController(webbanvlxdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ThuongHieu != null ? 
                          ...
                          Problem("Entity set 'webbanvlxdContext.ThuongHieu'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'webbanvlxdContext.ThuongHieu'  is null.");
            }
            var thuongHieu = await _context.ThuongHieu.FindAsync(id);
            if (thuongHieu != null)
            {
